      ...
      <table class="row" width="700" border="0" align="center" cellpadding="0" cellspacing="0" style="width:700px;max-width:700px;" bgcolor="#ffffff">
        <tbody><tr>
          <td align="center" valign="middle" style="padding:0;">
            <a href=""><img data-crop="false" mc:hideable="" mc:edit="" src="https://i.ibb.co/SwdfcRG/2022-03-24-13-32-05-Firefox-Developer-Edition.png" alt="#" border="0" width="100%" style="display:block;border:0;width:55%;"></a>
          </td>
        </tr>
      </tbody></table>
    </td>
              ...
              <tr>
                <td class="containerPadding" align="center" valign="top" style="font-size:0;padding:0">
                  ...
                  <table class="row" border="0" width="500" align="center" cellpadding="0" cellspacing="0" style="width:500px;max-width:500px;">
                    ...
                    <tbody><tr>
                      <td data-size="Section Headlines" data-color="Section Headlines" class="Section Headlines" align="center" valign="middle" style="font-family:'Poppins',Arial,Helvetica,sans-serif;color:#FFE487;font-size:40px;line-height:44px;font-weight:600;letter-spacing:0px;padding:0px;padding-bottom:20px;">
                        Order Confirmation
                      </td>
                    </tr>
        ...
        <tbody><tr>
          <td data-bgcolor="Inner Background Color" class="whiteBgcolor" align="center" valign="top" bgcolor="#FFFFFF">
            ...
            <table class="row" width="600" border="0" align="center" cellpadding="0" cellspacing="0" style="width:600px;max-width:600px;">
              ...
              <tr>
                <td data-size="Section Headlines" data-color="Section Headlines" class="Section Headlines centerText" align="center" valign="middle" style="font-family:'Poppins',Arial,Helvetica,sans-serif;color:#FFE487;font-size:25px;line-height:44px;font-weight:400;letter-spacing:0px;padding:0px;padding-bottom:3px;">
                  ...
                  <div class="row" style="display:inline-block;max-width:290px;vertical-align:top;width:100%;">
                    <table class="row" border="0" align="left" cellpadding="0" cellspacing="0">
                      <tbody>
                                        ...
                                        <tbody><tr>
                                            <td style="color: #FFE487;line-height: 24px; font-weight: 600; width: 290px;"> &nbsp;</td>
                    </tbody></table>
                  </div>
  ...
  <tbody><tr>
    <td align="center" valign="top">
        ...
        <tbody><tr>
          <td data-bgcolor="Inner Background Color" class="whiteBgcolor containerPadding" align="center" valign="top" bgcolor="#FFFFFF">
            ...
            <table class="row" width="600" border="0" align="center" cellpadding="0" cellspacing="0" style="width:600px;max-width:600px;">
              ...
              <tr>
                <td data-size="Section Headlines" data-color="Section Headlines" class="Section Headlines" align="left" valign="middle" style="font-family:'Poppins',Arial,Helvetica,sans-serif;color:#FFE487;font-size:22px;line-height:28px;font-weight:400;letter-spacing:0px;padding:0px;padding-bottom:8px; font-weight: bold;">
                  Shipping Details
                </td>
              </tr>
      ...
      order.paymentMethod.last4
              ...
              <tr>
                <td data-size="Section Headlines" data-color="Section Headlines" class="Section Headlines" align="center" valign="middle" style="font-family:'Poppins',Arial,Helvetica,sans-serif;color:#FFE487;font-size:22px;line-height:28px;font-weight:400;letter-spacing:0px;padding:0px;padding-bottom:8px; font-weight: bold;">
                  Connect With Us!
                </td>
              </tr>
                        ...
                        <tbody><tr>
                          <td align="center" valign="middle">
                            <a href="" style="text-decoration:none;border:0">
                              <img data-color="Icons" src="https://i.ibb.co/FHnNjKJ/facebook.png" alt="#" border="0" width="25" height="42" style="display:block;border:0;width:25px;height:42px;">
                            </a>
                          </td>
                        </tr>
                      </tbody></table>
                    ...
                    <td data-repeatable="" align="center" valign="middle" width="48">
                      <table border="0" align="center" cellpadding="0" cellspacing="0">
                        <tbody><tr>
                          <td align="center" valign="middle">
                            <a href="" style="text-decoration:none;border:0">
                              <img data-color="Icons" src="https://i.ibb.co/5WK3Ssg/instagram.png" alt="#" border="0" width="42" height="42" style="display:block;border:0;width:42px;height:42px">
                            </a>
                          </td>
                        </tr>
                      </tbody></table>
